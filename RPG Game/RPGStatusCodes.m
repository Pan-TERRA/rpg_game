...
NSString * const RPGStatusCodeActionTitle[] =
{
  ...
  [kRPGStatusCodeCharacterLevelIsLesserThanSkills] = @"OK",
  [kRPGStatusCodeNotEnoughMoney] = @"OK",
  [kRPGStatusCodeWrongUnit] = @"OK",
  [kRPGStatusCodeUnitIsAlreadyBought] = @"OK",
  [kRPGStatusCodeInsufficientCrystalsAmount] = @"OK",
  [kRPGStatusCodeDifferentClassOfCharacterAndQuest] = @"OK",
  [kRPGStatusCodeLevelOfCharacterAndQuest] = @"OK",
  [kRPGStatusCodeTooShortUsername] = @"OK",
  [kRPGStatusCodeTooLongUsername] = @"OK",
  [kRPGStatusCodeTooShortPassword] = @"OK",
  [kRPGStatusCodeTooLongPassword] = @"OK",
  [kRPGStatusCodeTooShortCharacterName] = @"OK",
  [kRPGStatusCodeTooLongCharacterName] = @"OK",
  [kRPGStatusCodeInvalidUsername] = @"OK",
  [kRPGStatusCodeInvalidCharacterName] = @"OK",
  [kRPGStatusCodeUndefinedSymbolsInUsername] = @"OK",
  [kRPGStatusCodeUndefinedSymbolsInCharacterName] = @"OK",
